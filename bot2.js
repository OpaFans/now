 ...
 * VERSI LENGKAP - v7 (SESI INTERAKTIF & MENU TEKS)
 * =======================================
 */
...
async function connectToWhatsApp() {
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        try {
            ...
            // Sesi Lapor
            if (global.laporSessions[sender] && !body.startsWith('.')) {
            ...
            // Sesi Topup
            if (global.topupSessions[sender] && !body.startsWith('.')) {
            ...
            if (global.serverAddSessions[sender] && !body.startsWith('.')) {
            ...
            if (global.setHargaSessions[sender] && !body.startsWith('.')) {
                ...
                try {
                    ...
                    if (session.step === 'awaiting_reg_price') {
                        ...
                        return reply(`✅ Harga Regular: *Rp ${price.toLocaleString('id-ID')}*\n\nSekarang masukkan *Harga Premium* (angka saja).\nKetik .batalkan untuk batal.`);
                        ...
                        return reply(`✅ Harga Premium: *Rp ${price.toLocaleString('id-ID')}*\n\nSekarang masukkan *Harga STB* (angka saja).\nKetik .batalkan untuk batal.`);
            ...
            if (global.replySessions[sender] && !body.startsWith('.')) {
            ...
            switch (command) {
                ...
                case 'setvpnprice': {
                    if (args.length === 5) {
                        ...
                        serverButtons.push({ id: '.batalkan', text: 'Batalkan' });
                ...
                case 'sethargatipe': {
                    ...
                    await sendButtons(sock, jid, {
                        text: `✅ Server: *${session.data.serverName.toUpperCase()}*\n✅ Tipe: *${vpnType.toUpperCase()}*\n\nSekarang masukkan *Harga Regular* (angka saja).\nContoh: 8000\n\nKetik .batalkan untuk batal.`,
                        buttons: [{ id: '.batalkan', text: 'Batalkan' }]
                    });
                } break;
                ...
                case 'help': {
                    ...
                    const welcomeText = `*ꜱᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ ${ownername.toUpperCase()} 👋*\n\n` + `┏━━━❏ *ɪɴꜰᴏ ᴜꜱᴇʀ* ❏━━━┓\n` +
                                       ...
                                       `ᴍᴏʜᴏɴ ᴘᴇɴɢᴇʀᴛɪᴀɴɴʏᴀ ᴊɪᴋᴀ ᴛᴇʀᴊᴀdi ʙᴜɢ ᴀᴛᴀᴜ ᴋᴇꜱᴀʟᴀʜᴀɴ 🙏\n` + `ᴋᴀᴍɪ ꜱᴀɴɢᴀᴛ ᴍᴇɴʜᴀʀɢᴀɪ ᴅᴜᴋᴜɴɢᴀɴ ᴅᴀɴ ᴍᴀꜱᴜᴋᴀɴɴʏᴀ! ❤️\n\n` +
